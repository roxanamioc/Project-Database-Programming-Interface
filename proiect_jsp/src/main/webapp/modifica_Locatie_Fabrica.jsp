...
<html>
    ...
    <body>
        ...
        <br/>
        <p align="center"><a href="nou_Locatie_Fabrica.jsp"><b>🛠️Adauga o noua locatie a unei fabrici🛠️</b></a> </p>
        <form action="m1_Locatie_Fabrica.jsp" method="post">
