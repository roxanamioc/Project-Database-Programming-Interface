...
<html>
    ...
    <body>
        ...
        <br/>
        <p align="center"><a href="nou_Model_Telefon.jsp"><b>🛠️Adauga un nou model de telefon🛠️</b></a></p>
        <form action="m1_Model_Telefon.jsp" method="post">
