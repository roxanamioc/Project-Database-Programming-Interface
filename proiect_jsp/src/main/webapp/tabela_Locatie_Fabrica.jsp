...
<html>
    <head>
        ...
        <title>Tabela Loctie Fabrica</title>
        <style>
    body {
    ...
    <body>
        ...
        <br/>
        <p align="center"><a href="nou_Locatie_Fabrica.jsp"><b>🛠️Adauga o noua locatie de fabrica🛠️</b></a></p>
        <form action="sterge_Locatie_Fabrica.jsp" method="post">
            <table border="1" align="center">
                ...
                <%
                    jb.connect();
                    ResultSet rs = jb.vedeTabela("locatiefabrica");
                    long x;
                    while (rs.next()) {
                        x = rs.getInt("idLocatieFabrica");
                %>
                <tr>
