...
public class JavaBean {
	...
	public void connect() throws ClassNotFoundException, SQLException, Exception {
		try {
			...
			// con = DriverManager.getConnection("jdbc:mysql://localhost:3306/roxi?user=root&password=ValentinPupezescu2021;");
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/telefon?useSSL=false", "root", "Roxifoxi02#");
	...
	public void connect(String bd) throws ClassNotFoundException, SQLException, Exception {
		try {
			Class.forName("com.mysql.cj.jdbc.Driver");
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/" + bd, "root", "Roxifoxi02#");
		} catch (ClassNotFoundException cnfe) {
			error = "ClassNotFoundException: Nu s-a gasit driverul bazei de date.";
			throw new ClassNotFoundException(error);
		} catch (SQLException cnfe) {
	...
	public void connect(String bd, String ip) throws ClassNotFoundException, SQLException, Exception {
		try {
			Class.forName("com.mysql.cj.jdbc.Driver");
			con = DriverManager.getConnection("jdbc:mysql://" + ip + ":3306/" + bd, "root", "Roxifoxi02#");
		} catch (ClassNotFoundException cnfe) {
			error = "ClassNotFoundException: Nu s-a gasit driverul bazei de date.";
			throw new ClassNotFoundException(error);
		} catch (SQLException cnfe) {
	...
	public void adaugaModelTelefon(String Nume, float Memorie_Interna, float Memorie_RAM, float Dimensiune_Ecran, int An_Aparitie)
		...
		if (con != null) {
			try {
				...
				stmt.executeUpdate("insert into modeltelefon(Nume, Memorie_Interna, Memorie_RAM, Dimensiune_Ecran, An_Aparitie) values('" + Nume + "'  , '" + Memorie_Interna + "', '" + Memorie_RAM + "', '" + Dimensiune_Ecran + "', '" + An_Aparitie + "');");
	...
	public void adaugaLocatieFabrica(String Oras, String Tara)
			throws SQLException, Exception {
		if (con != null) {
			try {
				// create a prepared SQL statement
				Statement stmt;
				stmt = con.createStatement();
				stmt.executeUpdate("insert into locatiefabrica(Oras, Tara) values('" + Oras + "'  , '" + Tara + "');");
	...
	public void adaugaCompanie(String Nume, String Fondator, int An_Infiintare, int idModelTelefon, int idLocatieFabrica)
		...
		if (con != null) {
			try {
				...
				Statement stmt;
				stmt = con.createStatement();
				stmt.executeUpdate("insert into companie(Nume, Fondator, An_Infiintare, idModelTelefon, idLocatieFabrica) values('" + Nume + "'  , '" + Fondator + "', '" + An_Infiintare + "', '" + idModelTelefon + "', '" + idLocatieFabrica + "');");
	...
	public ResultSet vedeTabela(String tabel) throws SQLException, Exception {
		ResultSet rs = null;
		try {
			String queryString = ("select * from `telefon`.`" + tabel + "`;");
	...
	public ResultSet vedeCompanie() throws SQLException, Exception {
		ResultSet rs = null;
		try {
			String queryString = ("select a.Nume NumeTel, a.Memorie_Interna , a.Memorie_RAM, a.Dimensiune_Ecran, a.An_Aparitie, b.Oras, b.Tara, c.idCompanie, c.Nume, c.Fondator, c.An_Infiintare, c.idModelTelefon idModelTelefon_comp, c.idLocatieFabrica idLocatieFabrica_comp from modeltelefon a, locatiefabrica b, companie c where a.idModelTelefon = c.idModelTelefon and b.idLocatieFabrica = c.idLocatieFabrica;");
			Statement stmt = con.createStatement(/*ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY*/);
			rs = stmt.executeQuery(queryString);
		} catch (SQLException sqle) {
			error = "SQLException: Interogarea nu a fost posibila.";
	...
	public ResultSet intoarceLinie(String tabela, int ID) throws SQLException, Exception {
		...
		try {
			// Execute query
			String queryString = ("SELECT * FROM " + tabela + " where idModelTelefon=" + ID + ";");
			Statement stmt = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
	...
	public ResultSet intoarceCompanieId(int ID) throws SQLException, Exception {
		ResultSet rs = null;
		try {
			// Execute query
			String queryString = ("SELECT a.Nume NumeTel, a.Memorie_Interna , a.Memorie_RAM, a.Dimensiune_Ecran, a.An_Aparitie, b.Oras, b.Tara, c.idCompanie, c.Nume, c.Fondator, c.An_Infiintare, c.idModelTelefon idModelTelefon_comp, c.idLocatieFabrica idLocatieFabrica_comp FROM modeltelefon a, locatiefabrica b, companie c WHERE a.idModelTelefon = c.idModelTelefon AND b.idLocatieFabrica = c.idLocatieFabrica and idCompanie = '" + ID + "';");
			Statement stmt = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
			rs = stmt.executeQuery(queryString); //sql exception
		} catch (SQLException sqle) {
			error = "SQLException: Interogarea nu a fost posibila.";
